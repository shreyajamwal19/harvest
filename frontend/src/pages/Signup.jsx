        ...
        <div className="card">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            <div>
              ...
              <input
                ...
                className={`input-field ${errors.name ? 'border-terracotta-300 focus:ring-terracotta-400' : ''}`}
                {...register('name', {
              ...
              />
              {errors.name && (
                <p className="mt-1 text-xs text-terracotta-600">{errors.name.message}</p>
              )}
            </div>
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium text-sage-700 mb-1.5">
                Confirm password
              </label>
              <input
                id="confirmPassword"
                ...
                className={`input-field ${errors.confirmPassword ? 'border-terracotta-300 focus:ring-terracotta-400' : ''}`}
              ...
              {errors.confirmPassword && (
                <p className="mt-1 text-xs text-terracotta-600">{errors.confirmPassword.message}</p>
              )}
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-sage-500">
              ...
              <Link to="/login" className="font-medium text-sage-700 hover:text-sage-900 transition-colors">
                Log in
              </Link>
            </p>
          </div>
